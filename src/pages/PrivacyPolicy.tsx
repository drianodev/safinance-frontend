        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              O Safinance ("nós", "nosso" ou "aplicativo") está comprometido em proteger sua privacidade. Esta Política de Privacidade 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              O Safinance não é destinado a menores de 18 anos. Não coletamos intencionalmente informações pessoais de menores. 
