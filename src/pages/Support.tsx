            ...
            <div className="space-y-6">
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">
                  Como criar uma conta no Safinance?
                </h3>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  ...
                  o valor limite e o período (mensal, semanal, etc.). O Safinance acompanhará seus gastos 
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">
                  O Safinance é gratuito?
                </h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  Sim! Atualmente o Safinance está em versão beta e é totalmente gratuito. 
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg p-6 border border-green-200 dark:border-green-800">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm">
                  Crie metas de economia para objetivos específicos. O Safinance acompanhará seu progresso 
